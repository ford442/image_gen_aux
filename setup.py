...
# since we save this data in src/diffusers_aux/dependency_versions_table.py it can be easily accessed from
# anywhere. If you need to quickly access the data from this table in a shell, you can do so easily with:
#
# python -c 'import sys; from diffusers_aux.dependency_versions_table import deps; \
...
class DepsTableUpdateCommand(Command):
    ...
    user_options = [
        ...
        (
            "dep-table-update",
            None,
            "updates src/image_gen_aux/dependency_versions_table.py",
        ),
    ]
    ...
    def run(self):
        ...
        target = "src/image_gen_aux/dependency_versions_table.py"
...
setup(
    ...
    description="Image generation auxiliary tools and libraries.",
    ...
    author_email="alvaro.somoza@huggingface.co",
    url="https://github.com/asomoza/image_gen_aux",
    package_dir={"": "src"},
    packages=find_packages("src"),
    package_data={"image_gen_aux": ["py.typed"]},
    include_package_data=True,
    python_requires=">=3.8.0",
    install_requires=list(install_requires),
    extras_require=extras,
    entry_points={"console_scripts": ["image_gen_aux-cli=image_gen_aux.commands.image_gen_aux:main"]},
    classifiers=[
